...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 加上项目名，形成完整地址
        gc.setOutputDir(projectPath + "/eoa-generator/src/main/java");
        // 作者
        gc.setAuthor("MAQJ");
        // 打开输出目录
        gc.setOpen(false);
        //x ml开启 BaseResultMap
        gc.setBaseResultMap(true);
        // xml 开启BaseColumnList,即通用查询结果列
...
//        pc.setModuleName(scanner("模块名"));
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/eoa-generator/src/main/resources/mapper/"
